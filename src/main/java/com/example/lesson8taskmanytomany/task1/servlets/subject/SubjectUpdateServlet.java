...
@WebServlet(
        name = "com.example.lesson8taskmanytomany.task1.servlets.subject.SubjectUpdateServlet",
...
public class SubjectUpdateServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        RequestDispatcher requestDispatcher = req.getRequestDispatcher("/views/subject/update.jsp");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (Objects.isNull(subject)) {
            ...
            subject.setName(Objects.requireNonNullElse(name, subject.getName()));
